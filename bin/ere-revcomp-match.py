...
"""
ere-revcomp-match.py

Test if a given sequence or its reverse complement is the best match to a target.

Prints the best match to stdout.

Example usage:

    ere-revcomp-match.py --target target.fasta < input.fasta > output.fasta
"""
...
parser = argparse.ArgumentParser("ere-revcomp-match.py")
parser.add_argument(
    "--target",
    required=True,
